...
const data = new ZingMp3();

const run = async () => {
    // console.log(await data.search('bông hoa đẹp nhất'))
    console.log(await data.getStreaming('67U69BCW'))
    // await data.search('son tùng')
}
